<?php include'includes/doctor_head.php'; ?>
<?php 
...
$sql_assessments = "SELECT id, case_number, duration_of_illness, condition_in_family, previous_medicine, medicine_names, food_intake_past_hours, intoxication_duration, abnormal_movement, movement_duration, created_at FROM central_nervous_system_assessments WHERE case_number = ?";
            ...
            <div class="container-fluid px-4">
                ...
                <div class="container mt-5">
                    ...
                    <form method="POST" action="">
                        ...
                        <input type="hidden" name="case_type" value="central_nervous_system_assessments">
